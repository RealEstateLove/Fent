--[[ 
    MILKYBOY FIXED THIS SKIBIDI FINOBE IS RETARDED AND A SKID
    MILKYBOY MADE THIS UI NOW
    FINOBE UR ASS AT CODING NIGGA
]]
...
-- Morphine init
    ...
    local flags = Morphine.flags
    local config_flags = Morphine.config_flags
    ...
    Morphine.__index = Morphine

    for _, path in next, Morphine.folders do 
        makefolder(Morphine.directory .. path)
    end 

    if setreadonly then 
        if not isfile(Morphine.directory .. "/fonts/main.ttf") then 
            writefile(Morphine.directory .. "/fonts/main.ttf", game:HttpGet("https://github.com/f1nobe7650/other/raw/main/uis/font.ttf"))
        end 
            ...
            faces = {
                {
                    ...
                    weight = 400,
                    style = "normal",
                    assetId = getcustomasset(Morphine.directory .. "/fonts/main.ttf")
                }
            }
        }
        
        if not isfile(Morphine.directory .. "/fonts/main_encoded.ttf") then 
            writefile(Morphine.directory .. "/fonts/main_encoded.ttf", http_service:JSONEncode(tahoma))
        end 
        
        Morphine.font = Font.new(getcustomasset(Morphine.directory .. "/fonts/main_encoded.ttf"), Enum.FontWeight.Regular)
    else 
        Morphine.font = Font.new("rbxasset://fonts/families/Zekton.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
    end 
...
-- Morphine functions 
    -- misc functions
        function Morphine:make_resizable(frame) 
            ...
            Morphine:connection(uis.InputChanged, function(input, game_event) 
        ...
        function Morphine:new_drawing(class, properties)
        ...
        function Morphine:new_item(class, properties) 
        ...
        function Morphine:convert_enum(enum)
            local enum_parts = {}
        ...
        function Morphine:config_list_update() 
            if not config_holder then return end 
        
            local list = {}
        
            for idx, file in next, listfiles(Morphine.directory .. "/configs") do
                local name = file:gsub(Morphine.directory .. "/configs\\", ""):gsub(".cfg", "")
                list[#list + 1] = name
            end
        ...
        function Morphine:load_config(config_json) 
            local config = http_service:JSONDecode(config_json)
        
            for _, v in next, config do 
                local function_set = Morphine.config_flags[_]
        ...
        function Morphine:round(number, float) 
            local multiplier = 1 / (float or 1)
            return math.floor(number * multiplier + 0.5) / multiplier
        end 

        function Morphine:apply_theme(instance, theme, property) 
            table.insert(themes.utility[theme][property], instance)
        end

        function Morphine:update_theme(theme, color)
        ...
        function Morphine:connection(signal, callback)
            local connection = signal:Connect(callback)
            
            table.insert(Morphine.connections, connection)

            return connection 
        end

        function Morphine:apply_stroke(parent) 
            local stroke = Morphine:create("UIStroke", {
                Parent = parent,
                Color = themes.preset.text_outline, 
                LineJoinMode = Enum.LineJoinMode.Miter
            }) 
            
            Morphine:apply_theme(stroke, "text_outline", "Color")
        end

        function Morphine:create(instance, options)
            ...
            if instance == "TextLabel" or instance == "TextButton" or instance == "TextBox" then 	
                Morphine:apply_theme(ins, "text", "TextColor3")
                Morphine:apply_stroke(ins)
            elseif instance == "ScreenGui" then 
                table.insert(Morphine.guis, ins)
            end 
    ...
    -- elements 
        function Morphine:panel(options) 
            local cfg = {
            ...
            local sgui = Morphine:create("ScreenGui", {
                Enabled = true,
                Parent = coregui,
                Name = "" 
            })

            local main_holder = Morphine:create("Frame", {
                Parent = sgui,
                Name = "",
            ...
            Morphine:apply_theme(main_holder, "outline", "BackgroundColor3") 
            
            local window_inline = Morphine:create("Frame", {
                Parent = main_holder,
                Name = "",
            ...
            Morphine:apply_theme(window_inline, "accent", "BackgroundColor3") 
            
            local window_holder = Morphine:create("Frame", {
            ...
            Morphine:apply_theme(window_holder, "outline", "BackgroundColor3") 
            
            local UIGradient = Morphine:create("UIGradient", {
            ...
            Morphine:apply_theme(UIGradient, "contrast", "Color") 
            
            local text = Morphine:create("TextLabel", {
                Parent = window_holder,
                Name = "",
                FontFace = Morphine.font,
            ...
            local UIStroke = Morphine:create("UIStroke", {
                Parent = text,
                Name = "",
                LineJoinMode = Enum.LineJoinMode.Miter
            })
            
            local UIPadding = Morphine:create("UIPadding", {
                Parent = window_holder,
                Name = "",
            ...
            local outline = Morphine:create("Frame", {
                Parent = window_holder,
                Name = "",
            ...
            Morphine:apply_theme(outline, "inline", "BackgroundColor3") 
            
            local inline = Morphine:create("Frame", {
                Parent = outline,
                Name = "",
                Position = dim2(0, 1, 0, 1),
                BorderColor3 = rgb(0, 0, 0),
            ...
            Morphine:apply_theme(inline, "outline", "BackgroundColor3") 
            
            local holder = Morphine:create("Frame", {
                Parent = inline,
                Name = "",
                Position = dim2(0, 1, 0, 1),
                BorderColor3 = rgb(0, 0, 0),
            ...
            local glow = Morphine:create("ImageLabel", {
                Parent = main_holder,
                Name = "",
            ...
            })Morphine:apply_theme(glow, "glow", "ImageColor3") 
        ...
        function Morphine:window(properties)
            local window = {}
            -- local button_holder  
            ...
            --[[local function create_dock_button(options) 
                ...
                local button = Morphine:create("TextButton", {
                ...
                local button_inline = Morphine:create("Frame", {
                    Parent = button,
                    Name = "",
                    Position = dim2(0, 1, 0, 1),
                    BorderColor3 = rgb(0, 0, 0),
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = rgb(32, 32, 38)
                })Morphine:apply_theme(button_inline, "outline", "BackgroundColor3") 
                ...
                local button_inline = Morphine:create("Frame", {
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = rgb(255, 255, 255)
                })Morphine:apply_theme(button_inline, "inline", "BackgroundColor3")
                ...
                local ImageLabel = Morphine:create("ImageLabel", {
                    Parent = button_inline,
                    Name = "",
                    ImageColor3 = themes.preset.accent,
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = rgb(255, 255, 255)
                })Morphine:apply_theme(ImageLabel, "accent", "ImageColor3") 
            ...
            -- main window
                local holder, path = Morphine:panel({
                ...
                window["tab_holder"] = Morphine:create("Frame", {
                    Parent = holder,
                    Name = " ",
                    BackgroundTransparency = 1,
                    Size = dim2(1, 0, 0, 22),
                ...
                local section_holder = Morphine:create("Frame", {
                    Parent = holder,
                    Name = " ",
                    BackgroundTransparency = 1,
                ...
                Morphine:apply_theme(outline, "outline", "BackgroundColor3") 
                ...
                Morphine:apply_theme(inline, "inline", "BackgroundColor3") 

                local background = Morphine:create("Frame", {
                    Parent = inline,
                    Name = "\0",
                    Position = dim2(0, 1, 0, 1),
                    BorderColor3 = rgb(0, 0, 0),
                ...
                Morphine.section_holder = background

                Morphine:create("UIPadding", {
                    Parent = background,
                    PaddingTop = dim(0, 4),
                    PaddingBottom = dim(0, 4),
                    PaddingRight = dim(0, 4),
                ...
                Morphine:make_resizable(path:FindFirstChildOfClass("Frame")) 
            -- 
            ...
            -- keybind list       
                ...
                Morphine:apply_theme(outline, "outline", "BackgroundColor3") 
                Morphine.keybind_list_frame = outline 
                ...
                local bg = Morphine:create("Frame", {
                    Parent = background,
                    Name = "a",
                    BorderColor3 = Color3.fromRGB(0, 0, 0),
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = themes.preset.accent
                }); Morphine:apply_theme(bg, "accent", "BackgroundColor3")
                
                
                Morphine:create("UIGradient", {
                    Parent = bg,
                    Name = "",
                    Enabled = true, 
                    Rotation = 90,
                ...
                local text_holder = Morphine:create("Frame", {
                    Parent = background,
                    Name = "",
                ...
                Morphine:apply_theme(text_holder, "outline", "BackgroundColor3")
                ...
                Morphine.keybind_list = background
            ...
            -- -- dock innit
            --     local dock_outline = Morphine:create("Frame", {
            --         Parent = sgui,
            --         Name = "",
            --         Visible = true,
            --         BorderColor3 = rgb(0, 0, 0),
            ...
            --         BorderSizePixel = 0,
            --         BackgroundColor3 = rgb(32, 32, 38)
            --     })Morphine:apply_theme(dock_outline, "outline", "BackgroundColor3") 
                
            --     local dock_inline = Morphine:create("Frame", {
            --         Parent = dock_outline,
            --         Name = "",
            --         Position = dim2(0, 1, 0, 1),
            --         BorderColor3 = rgb(0, 0, 0),
            ...
            --         BorderSizePixel = 0,
            --         BackgroundColor3 = rgb(60, 55, 75)
            --     })Morphine:apply_theme(dock_inline, "inline", "BackgroundColor3") 
                
            --     local dock_holder = Morphine:create("Frame", {
            --         Parent = dock_inline,
            --         Name = "",
            --         Size = dim2(1, -2, 1, -2),
            --         Position = dim2(0, 1, 0, 1),
            ...
            --         BorderSizePixel = 0,
            --         BackgroundColor3 = rgb(255, 255, 255)
            --     })Morphine:apply_theme(dock_holder, "outline", "BackgroundColor3") 
                
            --     local accent = Morphine:create("Frame", {
            --         Parent = dock_holder,
            --         Name = "",
            --         Size = dim2(1, 0, 0, 2),
            --         BorderColor3 = rgb(0, 0, 0),
            --         BorderSizePixel = 0,
            --         BackgroundColor3 = themes.preset.accent
            --     })Morphine:apply_theme(accent, "accent", "BackgroundColor3") 
            ...
            --     button_holder = Morphine:create("Frame", {
            --         Parent = dock_holder,
            --         Name = "",
            --         BackgroundTransparency = 1,
            --         Size = dim2(1, 0, 1, 0),
            ...
            --     local UIListLayout = Morphine:create("UIListLayout", {
            --         Parent = button_holder,
            --         Name = "",
            --         Padding = dim(0, 5),
            --         FillDirection = Enum.FillDirection.Horizontal,
            ...
            --     window["configs"], config_path = Morphine:panel({
            --         name = "Configurations", 
            ...
            -- -- playerlist 
            --     window["playerlist"], playerlist_gui = Morphine:panel({
            --         name = "Playerlist", 
            --         anchor_point = vec2(-1, 0),
            ...
            -- -- theming 
            --     window["themes"], themes_gui = Morphine:panel({
            --         name = "Style", 
            --         anchor_point = vec2(-1, 0),
            --         size = dim2(0, 322, 0, 391),
            ...
            return setmetatable(window, Morphine)
        end

        function Morphine:watermark(options) 
            local cfg = {
                default = options.text or options.default or os.date('drain.lol | %b %d %Y | %H:%M') -- highly skidded by finobe
            }

            local watermark_outline = Morphine:create("Frame", {
                Parent = sgui,
                Name = "",
                BorderColor3 = rgb(0, 0, 0),
                ...
                BackgroundColor3 = rgb(32, 32, 38)
            })Morphine:apply_theme(watermark_outline, "outline", "BackgroundColor3") 
            
            local watermark_inline = Morphine:create("Frame", {
                ...
                BorderSizePixel = 0,
                BackgroundColor3 = rgb(60, 55, 75)
            })Morphine:apply_theme(watermark_inline, "inline", "BackgroundColor3") 
            
            local watermark_background = Morphine:create("Frame", {
        ...
        function Morphine:tab(options)	
            ...
            -- button instances
                local tab_holder = Morphine:create("TextButton", {
                ...
                })Morphine:apply_theme(tab_holder, "outline", "BackgroundColor3") 
                ...
                Morphine:apply_theme(text, "accent", "TextColor3")
            
            -- section instances 
                local section_holder = Morphine:create("Frame", {
                    Parent = Morphine.section_holder,
                    BackgroundTransparency = 1,
                    Name = "\0",
                    BorderColor3 = rgb(0, 0, 0),
                    Size = dim2(1, 0, 1, 0),
            ...
            function cfg.open_tab()
                if Morphine.current_tab and Morphine.current_tab[1] ~= background then 
                    local button = Morphine.current_tab[1]
                    ...
                    Morphine.current_tab[2].Visible = false
                    
                    Morphine.current_tab = nil
                end
                
                Morphine.current_tab = {
                ...
                Morphine.current_tab[2].Visible = true 

                if Morphine.current_element_open and Morphine.current_element_open ~= cfg then 
                    Morphine.current_element_open.set_visible(false)
                    Morphine.current_element_open.open = false 
                    Morphine.current_element_open = nil 
                end
            end
            
            tab_holder.MouseButton1Click:Connect(cfg.open_tab)
            
            return setmetatable(cfg, Morphine) 
        end

        function Morphine:column(path) 
            local cfg = {}
            
            local holder = path and self[path] or self.holder
            
            local column = Morphine:create("Frame", {
                Parent = holder,
                BackgroundTransparency = 1,
                Name = "\0",
                BorderColor3 = rgb(0, 0, 0),
                ...
                BorderSizePixel = 0,
                BackgroundColor3 = rgb(60, 55, 75)
            })Morphine:apply_theme(column, "inline", "BackgroundColor3") 
        ...
        function Morphine:section(options)
            local cfg = {
                name = options.name or "Section", 
            }
            
            local section = Morphine:create("Frame", {
                Parent = self.holder,
                Name = "\0",
                BorderColor3 = rgb(0, 0, 0),
                Size = dim2(1, 0, 1, 0),
                BorderSizePixel = 0,
                BackgroundColor3 = rgb(60, 55, 75)
            })Morphine:apply_theme(section, "inline", "BackgroundColor3") 
            ...
            local ScrollingFrame = Morphine:create("ScrollingFrame", {
                Parent = background,
            ...
            })Morphine:apply_theme(ScrollingFrame, "accent", "ScrollBarImageColor3") 

            local elements = Morphine:create("Frame", {
        ...
        function Morphine:slider(options)
            local cfg = {
            ...
            local slider = Morphine:create("TextLabel", {
                Parent = self.holder, 
                FontFace = Morphine.font,
                TextColor3 = rgb(180, 180, 180),
                BorderColor3 = rgb(0, 0, 0),
            ...
            if cfg.name then 
                local left_components = Morphine:create("Frame", {
                    Parent = slider,
            ...
            local bottom_components = Morphine:create("Frame", {
                Parent = slider,
            ...
            local slider = Morphine:create("TextButton", {
                ...
                Text = "",
                AutoButtonColor = false,
            })Morphine:apply_theme(slider, "outline", "BackgroundColor3") 
            ...
            local background = Morphine:create("Frame", {
                ...
                BorderSizePixel = 0,
                BackgroundColor3 = themes.preset.accent
            })Morphine:apply_theme(background, "accent", "BackgroundColor3") 
            
            local contrast = Morphine:create("Frame", {
                Parent = background,
                Name = "contrast",
                BorderColor3 = rgb(0, 0, 0),
                Size = dim2(1, 0, 1, 0),
            ...
            local slidertext = Morphine:create("TextLabel", {
                Parent = contrast,
                FontFace = Morphine.font,
                TextColor3 = rgb(180, 180, 180),
                BorderColor3 = rgb(0, 0, 0),
            ...
            local fill = Morphine:create("Frame", {
                Parent = contrast,
                Name = "fill",
                BorderColor3 = rgb(0, 0, 0),
                ...
                BorderSizePixel = 0,
                BackgroundColor3 = themes.preset.accent
            })Morphine:apply_theme(fill, "accent", "BackgroundColor3") 
            ...
            function cfg.set(value)
                cfg.value = math.clamp(Morphine:round(value, cfg.intervals), cfg.min, cfg.max)
            ...
            Morphine:connection(uis.InputChanged, function(input)
            ...
            Morphine:connection(uis.InputEnded, function(input)
                if input.UserInputType == Enum.UserInputType.MouseButton1 then
                    cfg.dragging = false 
                end 
            end)
            ...
            Morphine.config_flags[cfg.flag] = cfg.set

            return self 
        end 

        function Morphine:toggle(options)
            local cfg = {
            ...
            -- instances
                local toggle_holder = Morphine:create("TextButton", {
                    Parent = self.holder,
                    FontFace = Morphine.font,
                ...
                local right_components = Morphine:create("Frame", {
                ...
                local list = Morphine:create("UIListLayout", {
                ...
                local toggle = Morphine:create("TextButton", {
                    Parent = left_components,
                    Name = "!toggle",
                    Text = "",
                    AutoButtonColor = false,
                    ...
                    ZIndex = 1, 
                    BackgroundColor3 = rgb(32, 32, 38)
                })Morphine:apply_theme(toggle, "outline", "BackgroundColor3") 
            ...
            Morphine:connection(toggle_holder.MouseButton1Click, function()
                cfg.enabled = not cfg.enabled
        
                cfg.set(cfg.enabled)
            end)

            Morphine:connection(toggle.MouseButton1Click, function()
                cfg.enabled = not cfg.enabled
        ...
        function Morphine:colorpicker(options)
            ...
            -- colorpicker button 
                local colorpicker_button = Morphine:create("TextButton", {
                    Parent = parent,
                    Name = "outline",
                    BorderColor3 = rgb(0, 0, 0),
                    Size = dim2(0, 24, 0, 14),
                    ...
                    Text = "",
                    AutoButtonColor = false,
                })Morphine:apply_theme(colorpicker_button, "outline", "BackgroundColor3") 
                ...
                local handler = Morphine:create("Frame", {
                    Parent = inline,
                    Name = "handler",
                    Position = dim2(0, 1, 0, 1),
                    BorderColor3 = rgb(0, 0, 0),
            ...
            -- colorpicker instances
                local colorpicker_holder = Morphine:create("Frame", {
                    Parent = sgui,
                    Name = "colorpicker",
                    ...
                    Visible = false,
                    ZIndex = 1
                })Morphine:apply_theme(colorpicker_holder, "outline", "BackgroundColor3") 

                Morphine:make_resizable(colorpicker_holder)
                ...
                local main_holder = Morphine:create("Frame", {
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = rgb(60, 55, 75)
                })Morphine:apply_theme(main_holder, "inline", "BackgroundColor3") 
                
                local main_holder_inline = Morphine:create("Frame", {
                    Parent = main_holder,
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = rgb(32, 32, 38)
                })Morphine:apply_theme(main_holder_inline, "outline", "BackgroundColor3") 
                
                local main_holder_background = Morphine:create("Frame", {
                ...
                local alpha = Morphine:create("TextButton", {
                    Parent = main_holder_background,
                    ...
                    Text = "",
                    AutoButtonColor = false,
                })Morphine:apply_theme(alpha, "inline", "BackgroundColor3") 
                ...
                local alpha_drag = Morphine:create("Frame", {
                    Parent = outline,
                    Name = "alpha_drag",
                    Position = dim2(0, 1, 0, 1),
                    BorderColor3 = rgb(0, 0, 0),
                ...
                local alphaind = Morphine:create("ImageLabel", {
                    Parent = alpha_drag,
                ...
                local alpha_picker = Morphine:create("Frame", {
                    Parent = alpha_drag,
                    Name = "alpha_picker",
                ...
                local hue = Morphine:create("TextButton", {
                    Parent = main_holder_background,
                ...
                local Frame = Morphine:create("Frame", {
                    Parent = outline,
                    Position = dim2(0, 1, 0, 1),
                    BorderColor3 = rgb(0, 0, 0),
                    Size = dim2(1, -2, 1, -2),
                ...
                local hue_picker = Morphine:create("Frame", {
                    Parent = Frame,
                    Name = "hue_picker",
                    BorderMode = Enum.BorderMode.Inset,
                    BorderColor3 = rgb(0, 0, 0),
                ...
                local visualize = Morphine:create("Frame", {
                    Parent = main_holder_background,
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = rgb(60, 55, 75)
                })Morphine:apply_theme(visualize, "inline", "BackgroundColor3") 
                ...
                local satval_picker = Morphine:create("Frame", {
                    Parent = main_holder_background,
                    Name = "satval_picker",
                    BorderColor3 = rgb(0, 0, 0),
                    Size = dim2(1, -20, 1, -20),
                    BorderSizePixel = 0,
                    BackgroundColor3 = rgb(60, 55, 75)
                })Morphine:apply_theme(satval_picker, "inline", "BackgroundColor3") 
                ...
                local colorpicker = Morphine:create("Frame", {
                    Parent = outline,
                    Name = "colorpicker",
                    Position = dim2(0, 1, 0, 1),
                    BorderColor3 = rgb(0, 0, 0),
                ...
                local sat = Morphine:create("TextButton", {
                    Parent = colorpicker,
                    Name = "sat",
                    Size = dim2(1, 0, 1, 0),
                    BorderColor3 = rgb(0, 0, 0),
                ...
                local val = Morphine:create("TextButton", {
                    Parent = colorpicker,
                    Name = "val",
                    BorderColor3 = rgb(0, 0, 0),
                    Size = dim2(1, 0, 1, 0),
                ...
                local satval_picker_REAL = Morphine:create("Frame", {
                    Parent = colorpicker,
            ...
            function cfg.set_visible(bool)
                ...
                if bool then 
                    ...
                    Morphine.current_element_open = cfg 
                end
            end 
        ...
        function Morphine:keybind(options)
            local parent = self.right_holder
            ...
            if cfg.name then 
                KEYBIND_ELEMENT = Morphine:create("TextLabel", {
                    Parent = Morphine.keybind_list,
                    Name = "",
                    FontFace = Morphine.font,
            ...
            local element_outline = Morphine:create("TextButton", {
                Parent = parent,
                Name = "",
                BorderColor3 = rgb(0, 0, 0),
                Text = "", 
                ...
                BorderSizePixel = 0,
                BackgroundColor3 = rgb(32, 32, 38)
            })Morphine:apply_theme(element_outline, "outline", "BackgroundColor3") 
            ...
            local key_text = Morphine:create("TextLabel", {
                Parent = handler,
                Name = "",
                FontFace = Morphine.font,
                TextColor3 = rgb(180, 180, 180),
            ...
            -- mode selector
                local keybind_selector = Morphine:create("Frame", {
                    Parent = sgui,
                    Name = "",
                ...
                local hold_button = Morphine:create("TextButton", {
                    Parent = keybind_selector,
                    Name = "",
                    FontFace = Morphine.font,
                    TextColor3 = rgb(180, 180, 180),
                ...
                local toggle_button = Morphine:create("TextButton", {
                    Parent = keybind_selector,
                    Name = "",
                    FontFace = Morphine.font,
                    TextColor3 = rgb(180, 180, 180),
                ...
                local always_button = Morphine:create("TextButton", {
                    Parent = keybind_selector,
                    Name = "",
                    FontFace = Morphine.font,
                    TextColor3 = rgb(180, 180, 180),
            ...
            -- init 
                ...
                function cfg.set(input)
                    ...
                    elseif type(input) == "table" then 
                        input.key = type(input.key) == "string" and input.key ~= "..." and Morphine:convert_enum(input.key) or input.key
                ...
                element_outline.MouseButton1Down:Connect(function()
                    ...
                    cfg.binding = Morphine:connection(uis.InputBegan, function(keycode, game_event)  
                ...
                Morphine:connection(uis.InputBegan, function(input, game_event) 
                ...
                Morphine:connection(uis.InputEnded, function(input, game_event) 
                    if game_event then 
                        return 
                    end 
        ...
        function Morphine:dropdown(options) 
            ...
            -- dropdown elements
                local dropdown = Morphine:create("TextLabel", {
                    Parent = parent,
                    FontFace = Morphine.font,
                    TextColor3 = rgb(180, 180, 180),
                    BorderColor3 = rgb(0, 0, 0),
                ...
                if cfg.name then 
                    ...
                    main_text = Morphine:create("TextLabel", {
                        Parent = left_components,
                        FontFace = Morphine.font,
                        TextColor3 = rgb(180, 180, 180),
                        BorderColor3 = rgb(0, 0, 0),
                ...
                local dropdown = Morphine:create("TextButton", {
                    Parent = bottom_components,
                    Name = "dropdown",
                    Position = dim2(0, 0, 0, 2),
                    BorderColor3 = rgb(0, 0, 0),
                    ...
                    Text = "",
                    AutoButtonColor = false, 
                })Morphine:apply_theme(dropdown, "outline", "BackgroundColor3") 
                ...
                local plus = Morphine:create("TextLabel", {
                    Parent = contrast,
                    TextWrapped = true,
                    TextColor3 = rgb(180, 180, 180),
                    BorderColor3 = rgb(0, 0, 0),
            ...
            -- dropdown holder
                local dropdown_holder = Morphine:create("Frame", {
                    Parent = sgui,
                    BorderColor3 = rgb(0, 0, 0),
                ...
                if not cfg.scrolling then 
                    background = Morphine:create("Frame", {
                        Parent = inline,
                        BorderColor3 = rgb(0, 0, 0),
                        Name = "background",
                        BackgroundTransparency = 1,
                    ...
                    background = Morphine:create("ScrollingFrame", {
                        Parent = inline,
                        BorderColor3 = rgb(0, 0, 0),
                        Name = "background",
                        BackgroundTransparency = 1,
                ...
                local stroke = Morphine:create("UIStroke", {
                    ...
                    Color = rgb(32, 32, 38),
                    LineJoinMode = Enum.LineJoinMode.Miter
                })Morphine:apply_theme(stroke, "outline", "Color") 
            ...
            function cfg:refresh_options(refreshed_list) 
                ...
                for i,v in next, refreshed_list do 
                    local TextButton = Morphine:create("TextButton", {
                        Parent = contrast,
                        FontFace = Morphine.font,
                        TextColor3 = themes.preset.text,
                        BorderColor3 = rgb(0, 0, 0),
                        ...
                        Text = v,
                        BackgroundColor3 = rgb(255, 255, 255)
                    })Morphine:apply_theme(TextButton, "accent", "TextColor3") 
        ...
        function Morphine:list(options)
            local cfg = {
            ...
            local list_holder = Morphine:create("TextLabel", {
                Parent = self.holder,
                Name = "",
                FontFace = Morphine.font,
                TextColor3 = rgb(180, 180, 180),
            ...
            local list = Morphine:create("Frame", {
                Parent = bottom_components,
                Name = "",
                Position = dim2(0, 0, 0, 2),
                BorderColor3 = rgb(0, 0, 0),
        ...
        function Morphine:textbox(options)
            local cfg = {
            ...
            local textbox_holder = Morphine:create("TextLabel", {
                Parent = self.holder,
                Name = "",
                FontFace = Morphine.font,
                TextColor3 = rgb(180, 180, 180),
            ...
            local button = Morphine:create("Frame", {
                Parent = textbox_holder,
                Name = "",
                Position = dim2(0, 0, 0, 2),
                BorderColor3 = rgb(0, 0, 0),
            ...
            Morphine:apply_theme(button, "outline", "BackgroundColor3") 
            ...
            local TextBox = Morphine:create("TextBox", {
                Parent = background,
                Name = "",
                CursorPosition = -1,
                FontFace = Morphine.font,
        ...
        function Morphine:button_holder(options) 
            local button_holder = Morphine:create("TextLabel", {
                Parent = self.holder,
                Name = "",
                FontFace = Morphine.font,
                TextColor3 = rgb(180, 180, 180),
        ...
        function Morphine:button(options)
            local cfg = {
                callback = options.callback or function() end, 
            ...
            local _UIGradient = Morphine:create("UIGradient", {
                Parent = background,
                Name = "",
                Rotation = 90,
                Color = rgbseq{
            ...
            Morphine:apply_theme(_UIGradient, "contrast", "Color") 
        ...
        function Morphine:label(options)
            ...
            local TextLabel = Morphine:create("TextLabel", {
                Parent = left_components,
                Name = "",
                FontFace = Morphine.font,
                TextColor3 = rgb(180, 180, 180),
        ...
        function Morphine:playerlist(options) 
            local cfg = {
                players = {}, 
                callback = options.callback or function() end, 
                selected_player, 
            ...
            -- elements 
                local playerlist_holder = Morphine:create("TextLabel", {
                    Parent = self.holder,
                    Name = "",
                    FontFace = Morphine.font,
                    TextColor3 = rgb(180, 180, 180),
                ...
                local list = Morphine:create("Frame", {
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = rgb(32, 32, 38)
                })Morphine:apply_theme(list, "outline", "BackgroundColor3") 
            ...
            function cfg.create_player(player) 
                ...
                local player_name = Morphine:create("TextLabel", {
                    Parent = TextButton,
                    Name = "",
                    FontFace = Morphine.font,
                    TextColor3 = rgb(180, 180, 180),
                ...
                Morphine:apply_theme(player_name, "text", "TextColor3") 
                Morphine:apply_theme(player_name, "accent", "TextColor3") 
                ...
                local priority_text = Morphine:create("TextLabel", {
                    Parent = TextButton,
                    Name = "",
                    FontFace = Morphine.font,
                    TextColor3 = rgb(180, 180, 180),
                ...
                local line = Morphine:create("Frame", {
                    Parent = ScrollingFrame,
                    Name = "",
                    BorderColor3 = rgb(0, 0, 0),
                    Size = dim2(1, 0, 0, 1),
